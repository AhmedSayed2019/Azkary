...
/**/
                      ...
                      Padding(
                        ...
                        child:
                            Image.asset(Assets.quranAyahNotification),
                      ),
                      Padding(
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            CupertinoSwitch(
                                // overrides the default green color of the track
                                activeColor: blueColor, // color of the round icon, which moves from right to left
                                thumbColor: Colors.white, // when the switch is off
                                trackColor: Colors.grey, // boolean variable value
                            ...
                            TextButton(
                                ...
                                child: Text("test".tr(), style: TextStyle(color: getValue("darkMode") ? Colors.white : Colors.black, fontSize: 12.sp, fontFamily: 'cairo'),)
                            ),
                            Row(
                              children: [
                                Text(
                      ...
                      Padding(
                        padding: const EdgeInsets.all(8),
                        child: Image.asset(Assets.quranZikrnotif),
                      ),
                      Padding(
                        padding: const EdgeInsets.all(3.0),
                        child: Material(
