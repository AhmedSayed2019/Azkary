...
class AppColor {
  // primary color
  static Clr primaryColor = const ColorModel(lightColor: Color(0xffF35371),darkColor:  Color(0xffF35371));
  static Clr primaryColorDark = const ColorModel(lightColor: Color(0xff0284C7),darkColor: Color(0xff43aee7));
  static Clr primaryColorLight = const ColorModel(lightColor: Color(0xffF9B0BE),darkColor: Color(0xffF9B0BE));
  ...
  //Error
  static Clr errorColor = const ColorModel(lightColor: Color(0xff96132C),darkColor: Colors.redAccent);
  ...
  //Gray
  static Clr shadowColor =  const ColorModel(lightColor: Color(0xff515151),darkColor:  Color(0xffc5c4c4));
...
LinearGradient getMainColorGradient() {
  return   LinearGradient(
      ...
      colors: [
        AppColor.primaryColorLight.lightColor,
        AppColor.primaryColor.lightColor,
