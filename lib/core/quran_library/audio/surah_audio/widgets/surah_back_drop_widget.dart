    ...
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color:
                (style?.backgroundColor ?? Theme.of(context).primaryColor).withValues(alpha: 0.01),
        ...
        child: Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              ...
              colors: [
                (style?.backgroundColor ?? Theme.of(context).primaryColor).withValues(alpha: 0.05),
                (style?.backgroundColor ?? Theme.of(context).primaryColor).withValues(alpha: 0.02),
              ],
            ),
            border: Border.all(
              color: (style?.backgroundColor ?? Theme.of(context).primaryColor)
