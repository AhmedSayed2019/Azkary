...
class _DefaultDrawer extends StatelessWidget {
  ...
  Widget _buildIndexSection(BuildContext context, List<String> jozzList,
    ...
    return ExpansionTile(
      ...
      backgroundColor: const Color(0xfff6d09d).withValues(alpha: isDark ? .6 : .1),
      collapsedBackgroundColor: const Color(0xfff6d09d).withValues(alpha: isDark ? .8 : .3),
      children: [
      ...
      children: List.generate(
        ...
        (index) => GestureDetector(
          ...
          child: Container(
            ...
            color: index.isEven ? const Color(0xfff6d09d).withValues(alpha: .1) : Colors.transparent,
            child: Row(
              children: [
                Expanded(
                  flex: 2,
                  child: FittedBox(
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        Text('${index + 1}'.convertNumbersAccordingToLang(languageCode: languageCode), style: QuranLibrary().naskhStyle.copyWith(fontSize: 18),
                        ),
                      ],
                    ),
                  ),
