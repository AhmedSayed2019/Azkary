...
extension FontSizeExtension on Widget {
  Widget fontSizeDropDown(
      {required BuildContext context,double? height, Color? color, required TafsirStyle tafsirStyle}) {
    final box = GetStorage();
    return PopupMenuButton(
      position: PopupMenuPosition.under,
      icon: Semantics(button: true, enabled: true, label: 'Change Font Size', child: tafsirStyle.fontSizeWidget),
