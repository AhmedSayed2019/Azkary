...
import 'package:azkark/features/adhan/notificationChooser/notifySelectBottomSheet.dart';
...
import 'package:azkark/features/adhan/widgets/timer.dart';
...
class AdhanItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final adhanTitleStyle = TextStyle().titleStyle();//context.textTheme.headlineMedium?.copyWith(color: context.textTheme.headlineMedium?.color);
    const iconSize = 24.0;
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    Text(_adhan.title, style: adhanTitleStyle, maxLines: 3),
                    Text(
                      '${_adhan.startTime.localizeTimeTo()} - ${_adhan.endTime.localizeTimeTo()}\n${getformatDuration(_adhan.timeOfWaqt, formatter, showSeconds: false, hour: ' ${tr('hour')} ', minute: ' ${tr('minute')}')}',
