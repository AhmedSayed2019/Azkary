...
List<String> listFromRange(int start, int end, NumberFormat formatter, {String suffix = '', String prefix = ''}){
  ...
  print('listFromRange ${list.length}');
  return list;
}
class NumberSpinner extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final List<String> minuteList = listFromRange(start, end, NumberFormat('00', context.locale.languageCode), suffix: tr("minute"));
    return AlertDialog(
        actions: [
          TextButton(
        ...
        content: SizedBox(
          ...
          child: ScrollablePositionedList.builder(
            ...
            itemBuilder: (ctx, j) => ListTile(
                title: Text(minuteList[j], textAlign: TextAlign.center,),
