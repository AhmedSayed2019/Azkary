                      ...
                      StreamBuilder<(int, Duration)>(
                        ...
                        builder: (context, snapshot) {
                          return snapshot.data?.$1 != 0
                              ? Row(
                                  children: [
                                    Text(_getPreyerLabel(snapshot.data?.$1), style:  const TextStyle().semiBoldStyle().activeColor()),
                                    ...
                                    Text(
                                      ...
                                      style: const TextStyle().semiBoldStyle().activeColor()/*prTextTheme.bodyLarge?.copyWith(fontWeight: FontWeight.w900)*/,
                                    ),
                                  ],
                                )
        ...
        child: Column(
          ...
          children: [
            Text(
              ...
              style: const TextStyle().semiBoldStyle().customColor((!isActive) ? Theme.of(context).primaryColor : colorScheme.onPrimary),
            ...
            Text(
              timeOfClock,
              style: const TextStyle().regularStyle().customColor((!isActive) ?  Theme.of(context).primaryColor : colorScheme.onPrimary),
              // style: prTextTheme.bodyMedium?.copyWith(
              //   color: (!isActive && isDark) ? colorScheme.onSurface : colorScheme.onPrimary,
              //   fontWeight: FontWeight.w700,
