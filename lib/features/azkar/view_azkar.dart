...
class _ViewAzkarState extends State<ViewAzkar> {
  ...
  // 74,97,75,76,79,87,80,81,86,78,77,90,94,82,84,88,89,85,83,295,296,297,95,93,92,91,96
  String get title {
    return isDiacriticsOpen
        ? Provider.of<CategoriesProvider>(context, listen: false)
            .getCategory(Provider.of<AzkarProvider>(context, listen: false).getZekr(0).categoryId).nameWithDiacritics
        : Provider.of<CategoriesProvider>(context, listen: false)
            .getCategory(Provider.of<AzkarProvider>(context, listen: false).getZekr(0).categoryId).nameWithoutDiacritics;
  }
