                                              ...
                                              child: Padding(
                                                ...
                                                child: SizedBox(
                                                  ...
                                                  child: RichText(
                                                    ...
                                                    text: TextSpan(style: TextStyle(color: primaryColors[getValue("quranPageolorsIndex")], fontSize: getValue("pageViewFontSize").toDouble(), fontFamily: getValue("selectedFontFamily")),
                                                      children: quran.getPageData(index).expand((e) {
                                                        ...
                                                        for (var i = e["start"]; i <= e["end"]; i++) {
                                                          ...
                                                          spans.add(TextSpan(
                                                            ...
                                                            text: i == e["start"] ? "${quran.getVerseQCF(e["surah"], i).replaceAll(" ", "").substring(0, 1)}\u200A${quran.getVerseQCF(e["surah"], i).replaceAll(" ", "").substring(1)}" : quran.getVerseQCF(e["surah"], i).replaceAll(' ', ''),

                                                            style: TextStyle(
                                                              color: bookmarks.where((element) => element["suraNumber"] == e["surah"] && element["verseNumber"] == i).isNotEmpty
                                                          ...
                                                          child: RichText(
                                                            ...
                                                            text: TextSpan(
                                                              style: TextStyle(
                                                                ...
                                                                fontSize: getValue("pageViewFontSize").toDouble() //.sp
                                                                ,
                                                                //
