...
//
// import '../../../../../core/res/values_manager.dart' as values_manager;
...
//                                               // width: values_manager.deviceWidth,
//                                               // height: values_manager.deviceHeight,
//                                               // padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
...
//                                                 minFontSize: widget.minFontSize, // will shrink down to this if needed
//                                                 stepGranularity: 0.5,     // smoother shrinking
//                                                 // overflowReplacement: const FittedBox(
...
//                                                     if (currentDuration != state.durations[state.durations.length - 1]["endDuration"]) {
//                                                       currentVersePlaying = state.durations.where((element) {return (element["startDuration"] <= currentDuration && currentDuration <= element["endDuration"]);}).first;
//                                                     }
//
//                                                     return Padding(
...
//                                                             text: TextSpan(
//                                                               style: TextStyle(
//                                                                 color: primaryColors[getValue("quranPageolorsIndex")], //wordSpacing: -.3,
...
//                                                                       TextSpan(
//                                                                         locale: const Locale("ar"),
//                                                                         recognizer:initLongPressGestureRecognizer(e: e, i: i, index: index),
...
//                                                                 setState(() {selectedSpan = " ${e["surah"]}$i";});
//                                                               }
...
//                                                                 style: TextStyle(color: primaryColors[getValue("quranPageolorsIndex")], fontSize: getValue("verseByVerseFontSize").toDouble(),
//                                                                   fontFamily: getValue("selectedFontFamily"),
//                                                                   backgroundColor: bookmarks.where((element) => element["suraNumber"] == e["surah"] && element["verseNumber"] == i).isNotEmpty ? Color(int.parse("0x${bookmarks.where((element) => element["suraNumber"] == e["surah"] && element["verseNumber"] == i).first["color"]}")).withOpacity(.19)
//                                                                       : shouldHighlightText
//                                                                       ? quran.getVerse(e["surah"], i) == widget.highlightVerse
//                                                                       ? highlightColors[getValue("quranPageolorsIndex")].withOpacity(.25)
//                                                                       : selectedSpan == " ${e["surah"]}$i"
...
//                                       await Provider.of<DownloadHelper>(context,listen: false).downloadAndCacheSuraAudio(quran.getSurahNameEnglish(state.suraNumber), quran.getVerseCount(state.suraNumber), state.suraNumber, reciters[getValue("reciterIndex")].identifier);
//
//                                       // await downloadAndCacheSuraAudio(quran.getSurahNameEnglish(state.suraNumber), quran.getVerseCount(state.suraNumber), state.suraNumber, reciters[getValue("reciterIndex")].identifier);
//                                       state.player.dispose();
...
//                                             });
//                                       }
//                                       qurapPagePlayerBloc.add(PlayFromVerse(currentVersePlaying, reciters[getValue("reciterIndex")].identifier, state.suraNumber, quran.getSurahNameEnglish(state.suraNumber)));
//                                       setState(() {});
//
//                                     },
...
//                                             style: TextStyle(fontSize: 12.sp,color: primaryColors[getValue("quranPageolorsIndex")])),
//                                       );
//                                     }).toList(),
//                                   ),
//
...
//                                               milliseconds: state.durations
//                                                   .where((element) =>
//                                               element["verseNumber"] == (currentVersePlaying[
//                                               "verseNumber"] + 1)).first["startDuration"]
//                                                   .toInt()));
//                                         }
//                                       },
...
//                                 ),
//                                 SizedBox(width: 16.w),
//                                 Text("play".tr(), style: TextStyle(fontFamily: "cairo", fontSize: 14.sp, color: primaryColors[getValue("quranPageolorsIndex")])),
//                                 SizedBox(width: 16.w),
...
//       // animationType: DialogTransitionType.size,
//       // context: context,
//       StatefulBuilder(builder: (context, setstatter) {
//         return Dialog(
...
//                               Share.share(
//                                 // "",
//                                 "{${removeDiacritics(verses.join(''))}} [${quran.getSurahNameArabic(surahNumber)}: $firstVerse : $lastVerse]${getValue("addAppSlogan") ? "Shared with Azkar - faithful companion" : ""}",
//                                 // "text/plain"
//                               );
//                             }
//                           } else {
...
//                               verseNumber++) {
//                                 String cTafseer =
//                                 await translate.getVerseTranslation(surahNumber, verseNumber, translationDataList[getValue("addTafseerValue")]);
...
//                               Share.share(
//                                 // "",
//                                 "{${verses.join('')}} [${quran.getSurahNameArabic(surahNumber)}: $firstVerse : $lastVerse]${getValue("addAppSlogan") ? "Shared with Azkar" : ""}",
//                                 // "text/plain"
//                               );
//                             }
//                           }
...
//                       },
//                       color: primaryColors[getValue("quranPageolorsIndex")],
//                       child: Text("astext".tr(), style: TextStyle(color: backgroundColors[getValue("quranPageolorsIndex")]))),
//                 ),
//               if (getValue("selectedShareTypeIndex") == 0)
//                 Padding(
//                   padding:
...
//                       onTap: () {
//                         Navigator.push(
//                             context, MaterialPageRoute(builder: (builder) => ScreenShotPreviewPage(
//                                     index: index,
