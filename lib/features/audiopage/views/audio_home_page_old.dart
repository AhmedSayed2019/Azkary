...
// import 'package:azkark/features/audiopage/views/reciter_all_surahs_page.dart';
...
//                                                       updateValue("favoriteRecitersList", json.encode(favoriteRecitersList));
//                                                     } else {
//                                                       print("adding favorites");
//                                                       favoriteRecitersList.add(reciter);
//                                                       updateValue("favoriteRecitersList", json.encode(
...
//                                               .map((e) => AudioCartItem(reciter: reciter, moshaf: e, suwar: suwar)/*Padding(
...
//                                                                         child: Text(e.name, overflow: TextOverflow.ellipsis, style: TextStyle(color: getValue("darkMode")?Colors.white.withOpacity(.87):Colors.black87, fontSize: 12.sp, fontFamily: 'cairo'),
//                                                                       ),
//                                                                       ),
//                                                                     ),
//                                                                   ],
...
//                                                                                     });
//                                                                               }
//                                                                               playerPageBloc.add(StartPlaying(initialIndex: 0, moshaf: e, buildContext: context, reciter: reciter, suraNumber: -1, jsonData: suwar));
//                                                                             },
//                                                                             icon: Icon(size: 20.sp, Icons.play_circle_outline, color: orangeColor)
//                                                                         ),
//                                                                         IconButton(
//                                                                             onPressed: () {playerPageBloc.add(DownloadAllSurahs(moshaf: e, reciter: reciter));},
