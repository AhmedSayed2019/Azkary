...
//           "${widget.reciter.name}${widget.mushaf.name}${4- 1}"));
  ...
  var searchQuery = "";
  final appDir = Directory("/storage/emulated/0/Download/azkar/");
          ...
          Scaffold(extendBodyBehindAppBar: true,
            ...
            body: Container(
              child: ListView.separated(
                ...
                itemCount: filteredSurahs.isNotEmpty ? filteredSurahs.length : selectedMode == "all" ? surahs.length : favoriteSurahs.length,
                itemBuilder: (BuildContext context, int index) {
                  dynamic surah = filteredSurahs.isNotEmpty ? filteredSurahs[index] : selectedMode == "all" ? surahs[index] : favoriteSurahs[index];
                  return EasyContainer(
                    ...
                    onTap: () async {
                      ...
                      playerPageBloc.add(StartPlaying(buildContext: context,
                          ...
                          suraNumber: int.parse(selectedMode == "all" ? surah["surahNumber"] : surah["surahNumber"]),
                    ...
                    child: ListTile(
                        leading: Image.asset(
                          "assets/images/icons/quran/${quran.getPlaceOfRevelation(int.parse(selectedMode == "all" ? surah["surahNumber"] : surah["surahNumber"])) == "makkah" || quran.getPlaceOfRevelation(int.parse(surah["surahNumber"])) == "makkah" ? "makkah" : "madinah"}.png",
                          height: 25.h,
                          width: 25.w,
                        ),
                        trailing: SizedBox(
                            ...
                            children: [
                              ...
                              GestureDetector(
                                ...
                                child: Icon(
                                    ...
                                    size: 24.sp,color:  Colors.redAccent),
