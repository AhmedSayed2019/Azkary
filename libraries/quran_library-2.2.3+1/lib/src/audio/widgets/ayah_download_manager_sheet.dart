        ...
        children: [
          ...
          Obx(() {
              ...
              return FilledButton.icon(
                ...
                style: ButtonStyle(
                  backgroundColor: WidgetStatePropertyAll(
                      style?.stopButtonBackground ?? Theme.of(context).primaryColor),
            ...
            return FilledButton.icon(
              ...
              style: ButtonStyle(
                backgroundColor: WidgetStatePropertyAll(
                    style?.downloadBackground ?? Theme.of(context).primaryColor),
                foregroundColor: WidgetStatePropertyAll(
                    style?.downloadForeground ?? Theme.of(context).primaryColor),
              ),
              icon: Icon(
                fullyDownloaded
      ...
      child: TweenAnimationBuilder<double>(
          ...
          builder: (context, value, child) => LinearProgressIndicator(
                ...
                valueColor: AlwaysStoppedAnimation<Color>(
                    (style?.progressColor ?? Theme.of(context).primaryColor)
                        .withValues(alpha: .25)),
              )),
    );
  }
