...
class _QuranTopBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color accentColor = defaults.accentColor ?? Theme.of(context).primaryColor;
              ...
              IconButton(
                icon: SvgPicture.asset(
                    ...
                    colorFilter: ColorFilter.mode(
                        defaults.iconColor ?? Theme.of(context).primaryColor, BlendMode.srcIn)),
                onPressed: () {
                ...
                if (defaults.showAudioButton ?? true)
                  IconButton(
                    icon: SvgPicture.asset(
                        ...
                        height: defaults.iconSize,
                        colorFilter: ColorFilter.mode(
                            defaults.iconColor ?? Theme.of(context).primaryColor,
                            BlendMode.srcIn)),
                    onPressed: () async {
...
class _MenuBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color accentColor = style.accentColor ?? Theme.of(context).primaryColor;
