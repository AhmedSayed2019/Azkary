...
class SurahInfoStyle {
  ...
  factory SurahInfoStyle.defaults({required bool isDark,required BuildContext context}) {
    return SurahInfoStyle(
      ...
      indicatorColor: Theme.of(context).primaryColor.withValues(alpha: .2),
      primaryColor: Theme.of(context).primaryColor.withValues(alpha: .2),
