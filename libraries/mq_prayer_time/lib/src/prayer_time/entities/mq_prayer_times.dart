...
String _getTimeFromat(DateTime time) => DateFormat('hh:mm a').format(time);
  String get fajrTime => _getTimeFromat(fajr);
  String get sunriseTime => _getTimeFromat(sunrise);
  String get dhuhrTime => _getTimeFromat(dhuhr);
  String get asrTime => _getTimeFromat(asr);
  String get maghribTime => _getTimeFromat(maghrib);
  String get ishaTime => _getTimeFromat(isha);

  // _getTimeFromat(DateTime time)=> DateFormat.Hm().format(time);
